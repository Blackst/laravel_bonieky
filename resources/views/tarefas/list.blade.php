...
@section('content')
    ...
    <a href="{{ route('tarefas.add')}}">Adicionar nova terefa</a>
        ...
        <ul>
            @foreach ($list as $item)
                <li>
                    ...
                    <a href="{{ route('tarefas.del', ['id'=>$item->id]) }}" onclick="return confirm('Tem certeza que deseja excluir este item ?')">[Excluir]</a>
                </li> 
            @endforeach
        </ul>
    @else
